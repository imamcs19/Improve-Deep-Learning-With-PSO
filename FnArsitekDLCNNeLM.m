function [ResultMAD]=FnArsitekDLCNNeLM(typeFitur)
...
[hFC11,W11,Bias11,Beta11]=FnELMtrainForcastTypeFitur(hP,target,...
    byk_neuron_hidden_layer,bykData,bykFilter,norm,typeFitur);

% 10. Fully connected ke-2, misal dengan train ELM
byk_neuron_hidden_layer=pengaliHidden*7;
%byk_neuron_hidden_layer=4
[hFC12,W12,Bias12,Beta12]=FnELMtrainForcastTypeFitur(hP,target,...
    byk_neuron_hidden_layer,bykData,bykFilter,norm,typeFitur);

% 11. Fully connected ke-3, misal dengan train ELM
byk_neuron_hidden_layer=pengaliHidden*4;
% byk_neuron_hidden_layer=4
[hFC13,W13,Bias13,Beta13]=FnELMtrainForcastTypeFitur(hP,target,...
    byk_neuron_hidden_layer,bykData,bykFilter,norm,typeFitur);
